        ...
        <div class="col-lg-12">
          <div class="jb-newsletter_area">
            <div class="newsletter-content">
              ...
              <p class="short-desc">
                Đăng ký gửi thư của UltraPhone để nhận thông tin cập nhật
    ...
    <footer class="footer-distributed">
      ...
      <div class="footer-center">
        ...
        <div>
          ...
          <p><a href="#">ultraphone@gmail.com</a></p>
        </div>
      ...
      <div class="footer-right">
        <p class="footer-company-about">
          ...
          UltraPhone - Bán lẻ chính hãng Điện thoại di động. Hệ thống hơn 100 cửa hàng toàn quốc.
