                        ...
                        <form class="form-horizontal" action="index.php?act=update_user" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="email1" class="col-sm-3 text-right control-label col-form-label">Mã người dùng</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?= $id_user ?>" disabled>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="email_user" class="form-control" value="<?= $email_user ?>">
                                    </div>
